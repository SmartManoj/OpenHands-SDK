...
from openhands.tools.execute_terminal.constants import MAX_CMD_OUTPUT_SIZE
from openhands.tools.execute_terminal.definition import ExecuteBashObservation
from openhands.tools.execute_terminal.metadata import CmdOutputMetadata


def test_execute_terminal_observation_truncation_under_limit():
...
def test_execute_terminal_observation_truncation_over_limit():
...
def test_execute_terminal_observation_truncation_with_error():
...
def test_execute_terminal_observation_truncation_exact_limit():
...
def test_execute_terminal_observation_truncation_with_prefix_suffix():
